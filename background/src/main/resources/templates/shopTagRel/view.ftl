    ...
    <#include "../leftbar.ftl"/>
                        ...
                        <el-collapse>
                            <el-collapse-item title="点击搜索" name="1">
                                <el-form :inline="true" :model="search" class="demo-form-inline">
                                    ...
                                    <el-form-item label="商品标签id">
                                        <el-input v-model="search.tagId"
                                                  placeholder="tagId"></el-input>
                                    </el-form-item>
                ...
                <el-row style="margin-top: 14px;">
                    <el-col :span="24">
                        <el-table :data="tableData" border="true" stripe="true" @selection-change="onSelectTableData">
                            ...
                            <el-table-column label="门店id" index="0">
                                <template slot-scope="scope">
                                    <span style="margin-left: 10px">{{  scope.row.shopId }}</span>
                                </template>
                            </el-table-column>
                            <el-table-column label="商品标签id" index="1">
                                <template slot-scope="scope">
        ...
        <el-dialog
            ...
            <el-form ref="form" :model="form" label-width="80px">
                ...
                <el-form-item label="商品标签id">
                    <el-input v-model="form.tagId">{{form.tagId}}</el-input>
                </el-form-item>
                <el-form-item label="修改时间">
...
<script>
    ...
    window.service = {
        add: function (form) {
            return axios.post(window.ctxPath + '/shopTagRel/add', form);
        },
        listPage: function (pageNo, pageSize, like) {
            ...
            return axios.get(window.ctxPath + '/shopTagRel/listPage?pageNo=' + pageNo + "&pageSize=" + pageSize + paramString);
        },
        update: function (form) {
            return axios.post(window.ctxPath + '/shopTagRel/update', form);
        },
        delete: function (id) {
            return axios.post(window.ctxPath + '/shopTagRel/remove?id=' + id);
        },
        deleteList: function (ids) {
            return axios.post(window.ctxPath + '/shopTagRel/removeList', ids);
        },
        goTo: function (model) {
