    ...
    <#include "../leftbar.ftl"/>
                            ...
                            <el-collapse-item title="点击搜索" name="1">
                                <el-form :inline="true" :model="search" class="demo-form-inline">
                                    ...
                                    <el-form-item label="openid">
                                        <el-input v-model="search.openid"
                ...
                <el-row style="margin-top: 14px;">
                    <el-col :span="24">
                        <el-table :data="tableData" border="true" stripe="true" @selection-change="onSelectTableData">
                            ...
                            <el-table-column label="手机号" index="3">
                                <template slot-scope="scope">
                                    <span style="margin-left: 10px">{{  scope.row.phone }}</span>
                                </template>
                            </el-table-column>
                            <el-table-column label="用户名" index="4">
                                <template slot-scope="scope">
                                    <span style="margin-left: 10px">{{  scope.row.nickName }}</span>
                                </template>
                            </el-table-column>
                            <el-table-column label="openid" index="5">
                                <template slot-scope="scope">
        ...
        <el-dialog
            ...
            <el-form ref="form" :model="form" label-width="80px">
                <el-form-item label="手机号">
                    <el-input v-model="form.phone">{{form.phone}}</el-input>
                </el-form-item>
                <el-form-item label="用户名">
...
<script>
    ...
    window.service = {
        add: function (form) {
            return axios.post(window.ctxPath + '/user/add', form);
        },
        listPage: function (pageNo, pageSize,like) {
            ...
            return axios.get(window.ctxPath + '/user/listPage?pageNo=' + pageNo + "&pageSize=" + pageSize + paramString);
        },
        update: function (form) {
            return axios.post(window.ctxPath + '/user/update', form);
        },
        delete: function (id) {
            return axios.post(window.ctxPath + '/user/remove?id=' + id);
        },
        deleteList: function (ids) {
            return axios.post(window.ctxPath + '/user/removeList', ids);
        },
        goTo: function (model) {
