...
<html lang="en">
    ...
    <body>
            ...
            <el-container style="height: 100%; border: 1px solid #eee">
                                    ...
                                    <el-collapse-item title="点击搜索" name="1">
                                        <el-form :inline="true" :model="search" class="demo-form-inline">
                                                    ...
                                                    <el-form-item label="product_id">
                                                        <el-input v-model="search.productId"
                                                                  placeholder="productId"></el-input>
                                                    </el-form-item>
                                            <el-form-item>
                        ...
                        <el-row style="margin-top: 14px;">
                            <el-col :span="24">
                                <el-table :data="tableData" border="true" stripe="true" @selection-change="onSelectTableData">
                                    ...
                                    <el-table-column label="order_id" index="3" >
                                        <template slot-scope="scope">
                                            <span style="margin-left: 10px">{{  scope.row.orderId }}</span>
                                        </template>
                                    </el-table-column>
                                    <el-table-column label="product_id" index="4" >
                                        <template slot-scope="scope">
                ...
                <el-dialog
                    ...
                    <el-form ref="form" :model="form" label-width="80px">
                        ...
                        <el-form-item label="product_id">
                            <el-input v-model="form.productId">{{form.productId}}</el-input>
                        </el-form-item>
                        <el-form-item>
        ...
        <script>
            ...
            window.service = {
                add: function (form) {
                    return axios.post(window.ctxPath+'/orderProductRel/add', form);
                },
                listPage: function (pageNo,pageSize,like) {
                    ...
                    return axios.get(window.ctxPath + '/orderProductRel/listPage?pageNo=' + pageNo + "&pageSize=" + pageSize + paramString);
                },
                update: function (form) {
                    return axios.post(window.ctxPath+'/orderProductRel/update', form);
                },
                delete: function (id) {
                    return axios.post(window.ctxPath+'/orderProductRel/remove?id=' + id);
                },
                deleteList: function (ids) {
                    return axios.post(window.ctxPath+'/orderProductRel/removeList', ids);
                },
                goTo: function (model) {
