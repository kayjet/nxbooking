...
<html lang="en">
    ...
    <body>
            ...
            <el-container style="height: 100%; border: 1px solid #eee">
                                    ...
                                    <el-collapse-item title="点击搜索" name="1">
                                        <el-form :inline="true" :model="search" class="demo-form-inline">
                                                    ...
                                                    <el-form-item label="user_id">
                                                        <el-input v-model="search.userId"
                        ...
                        <el-row style="margin-top: 14px;">
                            <el-col :span="24">
                                <el-table :data="tableData" border="true" stripe="true" @selection-change="onSelectTableData">
                                    ...
                                    <el-table-column label="user_id" index="3" >
                                        <template slot-scope="scope">
                ...
                <el-dialog
                    ...
                    <el-form ref="form" :model="form" label-width="80px">
                        ...
                        <el-form-item label="user_id">
                            <el-input v-model="form.userId">{{form.userId}}</el-input>
                        </el-form-item>
                        <el-form-item label="order_id">
        ...
        <script>
            ...
            window.service = {
                add: function (form) {
                    return axios.post(window.ctxPath+'/orderUserRel/add', form);
                },
                listPage: function (pageNo,pageSize,like) {
                    ...
                    return axios.get(window.ctxPath + '/orderUserRel/listPage?pageNo=' + pageNo + "&pageSize=" + pageSize + paramString);
                },
                update: function (form) {
                    return axios.post(window.ctxPath+'/orderUserRel/update', form);
                },
                delete: function (id) {
                    return axios.post(window.ctxPath+'/orderUserRel/remove?id=' + id);
                },
                deleteList: function (ids) {
                    return axios.post(window.ctxPath+'/orderUserRel/removeList', ids);
                },
                goTo: function (model) {
