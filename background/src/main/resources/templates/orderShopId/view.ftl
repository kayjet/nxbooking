...
<html lang="en">
    ...
    <body>
            ...
            <el-container style="height: 100%; border: 1px solid #eee">
                                ...
                                <el-collapse>
                                    <el-collapse-item title="点击搜索" name="1">
                                        <el-form :inline="true" :model="search" class="demo-form-inline">
                                                    <el-form-item label="shop_id">
                                                        <el-input v-model="search.shopId"
                                                                  placeholder="shopId"></el-input>
                                                    </el-form-item>
                        ...
                        <el-row style="margin-top: 14px;">
                            <el-col :span="24">
                                <el-table :data="tableData" border="true" stripe="true" @selection-change="onSelectTableData">
                                    ...
                                    <el-table-column label="shop_id" index="0" >
                                        <template slot-scope="scope">
                                            <span style="margin-left: 10px">{{  scope.row.shopId }}</span>
                                        </template>
                                    </el-table-column>
                                    <el-table-column label="update_time" index="1" >
                                        <template slot-scope="scope">
                                    ...
                                    <el-table-column label="order_id" index="4" >
                                        <template slot-scope="scope">
                ...
                <el-dialog
                    ...
                    <el-form ref="form" :model="form" label-width="80px">
                        <el-form-item label="shop_id">
                            <el-input v-model="form.shopId">{{form.shopId}}</el-input>
                        </el-form-item>
                        <el-form-item label="update_time">
                        ...
                        <el-form-item label="order_id">
                            <el-input v-model="form.orderId">{{form.orderId}}</el-input>
                        </el-form-item>
                        <el-form-item>
        ...
        <script>
            ...
            window.service = {
                add: function (form) {
                    return axios.post(window.ctxPath+'/orderShopId/add', form);
                },
                listPage: function (pageNo,pageSize,like) {
                    ...
                    return axios.get(window.ctxPath + '/orderShopId/listPage?pageNo=' + pageNo + "&pageSize=" + pageSize + paramString);
                },
                update: function (form) {
                    return axios.post(window.ctxPath+'/orderShopId/update', form);
                },
                delete: function (id) {
                    return axios.post(window.ctxPath+'/orderShopId/remove?id=' + id);
                },
                deleteList: function (ids) {
                    return axios.post(window.ctxPath+'/orderShopId/removeList', ids);
                },
                goTo: function (model) {
